...
static inline void register_user_actions(Interpreter *intp) {
    register_act(intp, "plot",  act_gfx_plot);
    register_act(intp, "color", act_gfx_color);
    register_act(intp, "clear", act_gfx_clear);
    register_act(intp, "up",    act_gfx_up);
    register_act(intp, "down",  act_gfx_down);
    register_act(intp, "left",  act_gfx_left);
    register_act(intp, "right", act_gfx_right);
}
